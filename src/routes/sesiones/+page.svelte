...
<style>
  ...
  .btn-new { background: #0c0c15; color: #fff; text-decoration: none; padding: 9px 18px; border-radius: 999px; font-weight: 700; font-size: 0.9rem; white-space: nowrap; }
  ...
  .chip { border: 1px solid rgba(12,12,21,0.15); background: transparent; padding: 5px 12px; border-radius: 999px; cursor: pointer; font-size: 0.82rem; font-weight: 600; color: #374151; }
  .chip.active { background: #0c0c15; color: #fff; border-color: #0c0c15; }
  ...
  .card {
    background: #fff; border: 1px solid rgba(12,12,21,0.07); border-radius: 14px;
  ...
  .snippet { margin: 0; font-size: 0.85rem; color: #6b7280; line-height: 1.45; }

  .meta-row { display: flex; gap: 8px; align-items: center; font-size: 0.78rem; color: #9ca3af; margin-top: auto; }
  .meta-saves { color: #f59e0b; font-weight: 700; }
  .meta-photos { color: #9ca3af; font-size: 0.75rem; }

  .action-chips, .tag-chips { display: flex; flex-wrap: wrap; gap: 4px; }
  .action-chip { font-size: 0.72rem; background: #ede9fe; color: #5b21b6; padding: 2px 8px; border-radius: 999px; font-weight: 600; }
  .tag-chip { font-size: 0.72rem; background: #f3f4f6; color: #6b7280; padding: 2px 8px; border-radius: 999px; }
  ...
  .skeleton { height: 240px; border-radius: 14px; background: linear-gradient(90deg, #f3f4f6 0%, #e5e7eb 50%, #f3f4f6 100%); background-size: 200% 100%; animation: shimmer 1.4s ease-in-out infinite; }
